package com.company.locale.endpoint.event;

import static java.util.UUID.randomUUID;
import static org.junit.jupiter.api.Assertions.assertEquals;

import com.company.locale.PojaGenerated;
import com.company.locale.conf.FacadeIT;
import com.company.locale.endpoint.event.gen.UuidCreated;
import com.company.locale.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "com.company.locale.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
